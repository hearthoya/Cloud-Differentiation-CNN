...
model.fit(train_data, epochs=40, validation_data=val_data, callbacks=[tensorboard_callback])
...
class_labels = ['Altocumulus', 'Altostratus', 'Circocumulus',
                'Cirrostratus', 'Cirrus', 'Contrail',
